/**
  * Simulates the Column of a Database, with some basic function that is balanced with constraints and check
  * @author Trang Vu
...
public class Attribute<V> {
  ...
  /**
    ...
    * "<", "<=" "=". After check added, the check will be checked while entering a value of Attribute
    * . Example "value >= 10"
  ...
  /**
    * Verify when user do addValue that the value is fit with with the constraints and check or
    * not
    */
